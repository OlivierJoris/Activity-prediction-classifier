...
\paragraph{}The implementation of this part can be found in the \texttt{feature\_selection.ipynb} notebook or in the \texttt{feature\_selection.py} python script. 
...
\paragraph{}Our different attempt of implementation can be found in the \texttt{feature\_extraction\_v*.ipynb} notebook or in the \texttt{feature\_extraction\_v*.py} Python script where * refer to the version of this feature extraction.
