...
if __name__ == '__main__':
    ...
    clf = KNeighborsClassifier(n_neighbors=25, random_state = 0).fit(X_train, y_train)
    y_test = clf.predict(X_test)
    write_submission(y_test, 'submissions', submission_name='16_knn_feature_extraction.csv')
